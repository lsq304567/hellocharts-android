...
public class TimeLineChartActivity extends ActionBarActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        private void generateData() {
            ...
            for (int i = 0; i < numberOfLines; ++i) {
                ...
                long time = TimeUnit.MILLISECONDS.toHours(System.currentTimeMillis());
                for (int j = 0; j < numberOfPoints; ++j) {

                    values.add(new PointValue(j + time, randomNumbersTab[i][j]));
                }
            ...
            if (hasAxes) {
                ...
                axisX.setFormatter(new AxisValueFormatter() {
                    ...
                    public int formatValueForManualAxis(char[] formattedValue, AxisValue axisValue) {
                        long millis = TimeUnit.MINUTES.toMillis((long) axisValue.getValue());
